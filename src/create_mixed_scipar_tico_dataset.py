...
train_dataset = load_from_disk('data/mixed_dataset_tico_scipar')
dev_dataset = load_dataset('sethjsa/tico_en_ru')
...
print(f"Percentage of indices below 2100: {sum([1 for i in indices if i <2100]) / len(indices) * 100:.2f}%")
