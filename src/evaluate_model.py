...
parser.add_argument('--torch_compile', action='store_false',
...
if __name__ == "__main__":
    ...
    eval_score = compute_metrics_test(test_dataset["test"][args.src_lang], test_dataset["test"][args.tgt_lang], predictions, bleu=True, comet=False, tokenizer=tokenizer)
